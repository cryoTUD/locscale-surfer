...
def train_one_epoch(epoch_idx, training_loader, track_every, patience, timestamp):
    running_loss = 0.
    last_loss = 0.
    ...
    with open(f'/home/tnw-nb4020-03/dev/bep_lotte_micelle/training_cubes/scunet_cz48/outputdata/{date}/batchloss_{timestamp}.txt', 'a') as f:
        ...
        for emmap, segm in tqdm(training_loader, leave=True):
            ...
            if i % track_every == track_every-1:
                ...
                print('>>> epoch {} batch {} loss: {}'.format(epoch_idx + 1, i + 1, last_loss))
                sys.stdout.flush()
                running_loss = 0.
...
def train_model(epochs, training_loader, validation_loader, track_every, patience, model_folder, timestamp):
    date = timestamp[:8]
    for epoch in range(epochs):
        with open(f'/home/tnw-nb4020-03/dev/bep_lotte_micelle/training_cubes/scunet_cz48/outputdata/{date}/batchloss_{timestamp}.txt', 'a') as f:
            ...
            avg_loss = train_one_epoch(epoch, training_loader, track_every, patience, timestamp)
...
if __name__ == "__main__":
    ...
    train_files = random.sample(train_files, 48*4)
    ...
    valid_files = random.sample(valid_files, 48*4)
    ...
    # cubedata_dir = '/home/tnw-nb4020-03/bep_lotte_micelle/training_cubes/scunet_cz48/cubedata_directory/'
    # save_dir = f'/home/tnw-nb4020-03/bep_lotte_micelle/training_cubes/scunet_cz48/outputdata/{date}'
    # train_cube_dir = '/home/tnw-nb4020-03/bep_lotte_micelle/training_cubes/scunet_cz48/cubedata_directory/cubedata_training/'
    # valid_cube_dir = '/home/tnw-nb4020-03/bep_lotte_micelle/training_cubes/scunet_cz48/cubedata_directory/cubedata_validation/'
    ...
    train_model(epochs, train_dataloader, valid_dataloader, 1, patience, model_folder, timestamp)